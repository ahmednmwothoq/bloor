<template>
    <div class="item item__product_rev">
        ...
        <div class="offer__info">
            <div  v-if="user == 'user'"  @click="this.$router.push({ name: 'showReview', params: { id: item.id }})">
                ...
                <div class="info__details">
                    <div class="detail__desc">
                        <span class="detail_title">Questionnaire:</span>
                    ...
                    <div class="detail__added">
                        <span class="detail_title">Added By:</span>
                    ...
                    <div class="detail__added">
                        <span class="detail_title">Date:</span>
                        <div class="added__person">
                            <div class="person_info">
            ...
            <div class="offer_request" v-else>
                ...
                <a class="request__btn" @click="this.$router.push({ name: 'addReview', params: { id: item.id }})" >Review</a>
            </div>
        </div>
    </div>
    ...
    <div :id="'theDivProductEdit-'+ item.id" class="add_product" style="display: none;">
        <h2 class="title_add">Edit Product</h2>
        <div class="form">
            <form class="">
                <div class="raw d-flex justify-content-between">
                    <div class="form-group col-lg-6 col-md-6 col-sm-12 mb-3">
                        <input type="text" v-model="item.product_ar" placeholder="Product Name Ar *"  class="custome-input widthInputOffset">
                    </div>
                    <div class="form-group col-lg-6 col-md-6 col-sm-12 mb-3">
                        <input type="text" v-model="item.product_en" placeholder="Product Name En *"  class="custome-input widthInputOffset">
                    </div>
                </div>
                <div class="raw d-flex justify-content-between">
                    <div class="form-group col-lg-6 col-md-6 col-sm-12 mb-3 ">
                        <input type="date" v-model="item.date" placeholder="Date *"  class="custome-input widthInputOffset">
                    </div>
                    <div class="form-group col-lg-6 col-md-6 col-sm-12 mb-3 ">
                        <input type="text" v-model="item.link" placeholder="Link *"  class="custome-input widthInputOffset">
                    </div>
                </div>
                <div class="raw">
    ...
    <div class="modal fade" :id="`deleteModalProduct${item.id}`" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-footer justify-content-center">
                ...
                <button type="button" class="btn btn-primary" @click="sentDeleteProduct(item.id)">Yes</button>
            </div>
            </div>
        </div>
    </div>
