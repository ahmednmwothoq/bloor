    ...
    <main class="__content">
        ...
        <div class="content__right">
            <div class="header__nav">
                <a class="nav__item item__active" @click="redirectTo({ val: 'userLogin' })">{{ $t('login_nav') }}</a>
                <a @click="redirectTo({ val: 'userSignUp' })" class="nav__item">{{ $t('sign_up_nav') }}</a>
            ...
            <div class="form">
                ...
                <form @click.prevent class="right__down">
                    ...
                    <div class="form__submit">
                        ...
                        <a class="btn__forgot cursor_pointer" @click="this.$router.push('/user-forget-pass')" target="_blank">{{ $t('forgot_password') }}</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    methods:{
        ...
        async loginForm(){
            ...
            if(!this.v$.$error){
                ...
                await Api.authUser.signIn(payload).then((res) => {
                    if(res.data.status){
